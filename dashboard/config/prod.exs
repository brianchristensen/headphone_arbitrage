...
config :dashboard, SocketGallowsWeb.Endpoint,
...
config :dashboard, authentication: [
  ...
  password: {:system, "BASIC_AUTH_PASS"},
  realm:    {:system, "BASIC_AUTH_REALM"}
]

config :data, elasticsearch_address: {:system, "ESADDR"}
config :web_scraper, headfi_pages_init: 20
config :web_scraper, watch_interval_seconds: 60
# ## SSL Support
#
